    ...
    return (
        <div className="welcome">
            ...
            <div className="buttons-categories">
                <Link to="/questions" className="button-category general-knowledge" onClick={() => setCategory('9')}>General Knowledge</Link>
                <Link to="/questions" className="button-category celebrities" onClick={() => setCategory('26')}>Celebrities</Link>
                <br></br>
                <Link to="/questions" className="button-category movies" onClick={() => setCategory('11')}>Movies</Link>
                <Link to="/questions" className="button-category math" onClick={() => setCategory('19')}>Math</Link>
            </div>
        </div>
    )
}