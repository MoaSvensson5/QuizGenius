...
export function StartView (){
    ...
    function TargetValueClick(value) {
        ...
        <div className="welcome">
            {!buttonClicked ? ( <>
                ...
                <div className="buttons-categories">
                    <button className="button-category general-knowledge" onClick={() => TargetValueClick('9')}>General Knowledge</button>
                    <button className="button-category celebrities" onClick={() => TargetValueClick('26')}>Celebrities</button>
                    <br></br>
                    <button className="button-category movies" onClick={() => TargetValueClick('11')}>Movies</button>
                    <button className="button-category math" onClick={() => TargetValueClick('19')}>Math</button>
                </div>
            </>
            ) : 
            (
                <RenderQuestions category={selectedCategory}/>
            )}
        </div>
    )
}